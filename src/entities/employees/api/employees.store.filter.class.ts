import { TFilterEmployees } from "../types/employees.store.types";

export class EmployeesFilter {
    readonly filters: TFilterEmployees = {
        id: undefined,
        id2: undefined,
    ...
    constructor(filters?: TFilterEmployees) {
        if (filters) {
    ...
    getFilter(): any[] {
        return [
            ...
            this.filters.q,
            this.filters.fired,
            this.filters.xLastScheduledDay,
